...
class GalleryController extends BaseController
{
    ...
    function initialCall()
    {
        ...
        // gallery;
        $TransactionModel = new GalleryModel();
        $data = $TransactionModel->getResultData('gallery');
    ...
    function saveDataAjax()
    {
        ...
        if ($GalleryModel->saveTableData($postData)) {
            // Get the updated list of gallery
            $data["list"] = $GalleryModel->findAll();
    ...
    function updateDataAjax()
    {
        ...
        if ($GalleryModel->updateItemDetails($postData, $id)) {
            // Get the updated list of gallery
            $data["list"] = $GalleryModel->findAll();
            // Send success response with data and status code 200
            return $this->response->setStatusCode(200)->setJSON(['status_code' => 200, 'data' => $data["list"]]);
