        ...
        <ul class="menu-inner py-1">
          ...
          <li class="menu-item ">
            <a href="/testimonials" class="menu-link">
              <div class="text-truncate" data-i18n="Analytics">Add Testimonials</div>
            </a>
          </li>
          <li class="menu-item ">
            <a href="/gallery" class="menu-link">
              <div class="text-truncate" data-i18n="Analytics">Add Gallery</div>
            </a>
          </li>
          <li class="menu-item ">
            <a href="/result" class="menu-link">
              <div class="text-truncate" data-i18n="Analytics">Add Toppers</div>
            </a>
          </li>
          <li class="menu-item ">
            <a href="/logout" class="menu-link">
              <div class="text-truncate" data-i18n="Analytics">Log Out</div>
            </a>
          </li>
